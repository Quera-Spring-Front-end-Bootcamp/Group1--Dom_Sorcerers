import { Stack, HStack, Button, Text, Icon, Link } from "@chakra-ui/react";
    ...
    return (
        <>
            <HStack>
                ...
                <Stack borderLeft="0.5px solid rgba(170, 170, 170, 1)"
                    as="aside"
                    width="340px"
                    alignItems="center"
                    background="#FAFBFC"
                    ...
                    <Stack width="284px" height="500px" gap={"32px"}>
                        <Button colorScheme="teal" _hover={{ backgroundColor: "#208D8E" }} width={"110px"} height={"39px"} paddingRight="8px" gap={"8px"} fontSize={"20px"} fontWeight={"500"}>
                            <Icon>

                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.48047 12.48H19.4705" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M13.4834 6.48804L19.5204 12.5L13.4834 18.512" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </Icon>
                            <Text>بازگشت</Text>
                        </Button>
                        ...
                        <Link href="personal-info">
                            <HStack sx={styles} backgroundColor={"#C5FFFF"}>
                                <Icon>
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.0005 5.7C16.7005 7.4 16.7005 10.1 15.0005 11.7C13.3005 13.3 10.6005 13.4 9.00048 11.7C7.40048 10 7.30048 7.3 9.00048 5.7C10.7005 4.1 13.3005 4.1 15.0005 5.7" stroke="#323232" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <Link href="account-info">
                            <HStack sx={styles} cursor="pointer">
                                <Icon>
                                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="12.0008" cy="8.7486" r="4.25177" stroke="#323232" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M3.99707 20.5036C3.99707 18.0175 6.01291 16.0017 8.49895 16.0017H11.083" stroke="#323232" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M19.0031 17.4402L16.0019 20.4414L14.2021 18.6407" stroke="#323232" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </Icon>
